...
<Tabs>
  <Tab title="Dark">
    <img src="/images/dashboard-graph-dark.png" alt="Draggable connection canvas with Codex, Claude Code, Chrome and Brave in dark theme" />
  </Tab>
  <Tab title="Light">
    <img src="/images/dashboard-graph-light.png" alt="Draggable connection canvas with Codex, Claude Code, Chrome and Brave in light theme" />
  </Tab>
</Tabs>
