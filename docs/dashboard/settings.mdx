---
title: "Settings page"
description: "Pairing, port, HTTP endpoint, developer-browser policy, activity log, appearance and the emergency stop."
---
...
Shows the [HTTP endpoint](/connect/http-and-gemini) with a copy button once paired:
