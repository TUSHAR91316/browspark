...
description: "Connect Chrome and Brave profiles and run Firefox or Zen developer sessions through one companion."
---
...
| Firefox | Unavailable | `browser: "firefox"` |
| Zen | Unavailable | `browser: "zen"` |
| Other Chromium browsers | Install the extension where supported | `browser: "chromium"` with `browserPath` |

Firefox and Zen use WebDriver BiDi and have [documented tool exceptions](/reference/firefox). Their developer sessions have separate profiles and do not attach to your everyday Firefox or Zen tabs.

## Connect Chrome and Brave
...
Create profiles independently: copying a profile's Browspark storage duplicates its installation identity and currently makes the copies replace each other's connection. See [troubleshooting](/guides/troubleshooting#two-copied-profiles-keep-reconnecting).
