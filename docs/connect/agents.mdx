...
<Note>
Clients that take a URL instead of a command, including Gemini, are covered in [HTTP endpoint and Gemini](/connect/http-and-gemini). Running several of these clients at once is fine: see [Multiple agents](/connect/multiple-agents).
</Note>
