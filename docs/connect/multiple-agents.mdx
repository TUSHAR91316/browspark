...
<img src="/images/multiple-agents.gif" alt="Several MCP clients reaching one extension: the first companion owns port 9223, later ones relay to it over HTTP, and HTTP clients connect to the owner directly" />
