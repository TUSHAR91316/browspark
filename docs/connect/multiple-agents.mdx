...
You can connect as many agents as you like. They share one companion and access to its connected browser profiles and developer contexts, while each keeps its own tab ownership and recordings. Chrome, Brave, Firefox and Zen extensions and separate developer contexts can connect together. See [Using multiple browsers](/reference/multiple-browsers).

The dashboard's [Graph page](/dashboard/graph) shows established agent sessions, connected browser profiles and developer contexts linked through that companion. It updates as connections change and can be hidden with **Settings → Connection graph**.
...
<picture className="block dark:hidden">
  <source media="(prefers-reduced-motion: reduce)" srcSet="/images/multiple-agents-light.svg" />
  <img src="/images/multiple-agents-light.gif" alt="Stdio clients, HTTP clients and relays reach one companion, which connects multiple Chromium and Firefox profiles and separate developer browsers" />
</picture>
<picture className="hidden dark:block">
  <source media="(prefers-reduced-motion: reduce)" srcSet="/images/multiple-agents-dark.svg" />
  <img src="/images/multiple-agents-dark.gif" alt="Stdio clients, HTTP clients and relays reach one companion, which connects multiple Chromium and Firefox profiles and separate developer browsers" />
</picture>
