...
Firefox extension mode captures screenshots but cannot print PDFs. Its JavaScript world is isolated from the page, so page-exposed JavaScript tools may be unavailable. See [Firefox extension limits](/reference/firefox#extension-tool-coverage).
