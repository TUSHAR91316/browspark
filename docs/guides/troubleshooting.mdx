...
The sandbox cannot see the source tree or `bun`. Use the HTTP URL from Settings, or set the sandbox to Full Access and use full executable paths, or point it at the compiled `dist/browspark`. See [HTTP endpoint and Gemini](/connect/http-and-gemini).
