...
flowchart LR
  ...
  C -->|"WebSocket"| E["Chromium and Firefox extensions"]
...
- **Extension** (`extension/`): a Manifest V3 background process that connects each browser profile to the companion. Chromium uses the debugger API; Firefox uses WebExtension APIs and sandboxed user scripts. Its full-page dashboard controls sharing, tool switches and the activity log. Several profiles can connect simultaneously.
