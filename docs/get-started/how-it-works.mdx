...
<img className="block dark:hidden" src="/images/how-it-works-light.gif" alt="An MCP client talks to the companion over stdio or HTTP; the companion drives shared tabs through the Chrome extension over WebSocket, or a developer-mode Chrome directly over CDP" />
<img className="hidden dark:block" src="/images/how-it-works-dark.gif" alt="An MCP client talks to the companion over stdio or HTTP; the companion drives shared tabs through the Chrome extension over WebSocket, or a developer-mode Chrome directly over CDP" />
